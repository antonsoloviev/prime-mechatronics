      ...
      <div className="container mx-auto flex flex-col gap-4">
        <div className="container mx-auto flex flex-col sm:flex-row items-center">
          <div className="flex flex-col gap-4 w-full md:w-1/2 mb-4 items-center sm:items-start">
            ...
            <div>
              <a
                href="mailto:info@primemechatronics.com"
                className="text-gray-300 pt-1 pb-1 hover:text-white"
              >
                info@primemechatronics.com
              </a>
            </div>
            <div>
              <a
                href="tel:+375297024408"
                className="text-gray-300 pt-1 pb-1 hover:text-white"
              >
                +375297024408
              </a>
            ...
            <div className="flex items-center gap-6">
              <div className="flex justify-center items-center text-gray-300 cursor-pointer hover:text-white">
                <svg className="fill-current h-7" viewBox="0 0 16 16">
